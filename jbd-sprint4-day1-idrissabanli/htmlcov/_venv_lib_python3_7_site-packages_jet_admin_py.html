...
<head>
    ...
    <title>Coverage for .venv/lib/python3.7/site-packages/jet/admin.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>.venv/lib/python3.7/site-packages/jet/admin.py</b> :
...
<div id="source">
    ...
    <p id="t4" class="run"><span class="n"><a href="#t4">4</a></span><span class="t"><span class="key">class</span> <span class="nam">CompactInline</span><span class="op">(</span><span class="nam">admin</span><span class="op">.</span><span class="nam">options</span><span class="op">.</span><span class="nam">InlineModelAdmin</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t5" class="run"><span class="n"><a href="#t5">5</a></span><span class="t">    <span class="nam">template</span> <span class="op">=</span> <span class="str">'admin/edit_inline/compact.html'</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
